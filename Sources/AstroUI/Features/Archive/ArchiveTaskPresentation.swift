...
/// instead of relying on the extraction pass. All seven cases already had
/// entries from `ArchiveTaskCard`'s own former `title` switch (Task 8) --
/// moving the switch here changes nothing about which strings need a
/// translation.
