...
public struct NightBriefingHTMLRenderer: Sendable {
    ...
    public func render(_ document: NightBriefingDocument) -> String {
        ...
        .box { font-size: 16pt; line-height: 1; } small { display: block; color: #596579; margin-top: .5mm; } .notes-lines { height: 145mm; background: repeating-linear-gradient(to bottom, transparent 0, transparent 9mm, #cbd5e1 9mm, #cbd5e1 9.3mm); }
        </style></head><body>
