...
struct GlossarySheet: View {
    ...
    private static let terms: [Term] = [
        ...
        Term(name: "Karantén", definition: "Az Audit oldal \"Takarítható\"-script célmappája: a talált feleslegleges/duplikált fájlokat ide MOZGATJA (`mv`), soha nem törli. A karantént a felhasználó üríti ki kézzel, saját döntése alapján."),
