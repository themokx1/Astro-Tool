...
public enum ProductInfo: Sendable {
    ...
    public static let version = "3.0.0-beta.1"
    public static let build = "30001"
    ...
    public static let documentationURL = "https://themokx1.github.io/Astro-Tool/first-steps.html"
