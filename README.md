...
- A bővített célpont-katalógus (SIMBAD/VizieR) alapból be van kapcsolva, és
  a Tervező első megnyitásakor magától letölti a hiányzó katalógusadatokat.
  Ekkor és a "Katalógus frissítése" művelet futtatásakor kizárólag
  katalógusnevek és koordináták kerülnek a szolgáltatáshoz, a könyvtár
  fájljai, elérési útjai vagy jegyzetei soha. A Beállításokban bármikor
  kikapcsolható; az első letöltés után a Planning offline is működik a
  letöltött adatokkal. Lásd
